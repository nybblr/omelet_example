...
MonthlySales.create(:category => "Media", :total_cents => "139699", :total_currency => "USD", :units => 244, :date => Date.parse("February 2012")).save
MonthlySales.create(:category => "Media", :total_cents => "190369", :total_currency => "USD", :units => 74, :date => Date.parse("March 2012")).save
MonthlySales.create(:category => "Media", :total_cents => "146518", :total_currency => "USD", :units => 222, :date => Date.parse("April 2012")).save
MonthlySales.create(:category => "Media", :total_cents => "174748", :total_currency => "USD", :units => 319, :date => Date.parse("May 2012")).save
MonthlySales.create(:category => "Media", :total_cents => "122728", :total_currency => "USD", :units => 403, :date => Date.parse("June 2012")).save
MonthlySales.create(:category => "Media", :total_cents => "159770", :total_currency => "USD", :units => 457, :date => Date.parse("July 2012")).save
MonthlySales.create(:category => "Media", :total_cents => "138042", :total_currency => "USD", :units => 469, :date => Date.parse("August 2012")).save
MonthlySales.create(:category => "Media", :total_cents => "110289", :total_currency => "USD", :units => 216, :date => Date.parse("September 2012")).save
MonthlySales.create(:category => "Media", :total_cents => "162115", :total_currency => "USD", :units => 278, :date => Date.parse("October 2012")).save
